const { Mesh, IcosahedronGeometry, ShaderMaterial, DoubleSide } = THREE;
...
export class GroundProjectedEnv extends Mesh {
	...
	constructor( texture, options = {}) {
        ...
        const w = (_ref = isCubeMap ? (_texture$image$ = texture.image[0]) === null || _texture$image$ === void 0 ? void 0 : _texture$image$.width : texture.image.width) !== null && _ref !== void 0 ? _ref : 1024;
		const cubeSize = w / 4;
