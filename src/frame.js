...
AFRAME.registerComponent("frame", {
  ...
  update(oldData) {
    ...
    if (this.data.name && !this.title)
    {
      ...
      title.setAttribute('text', `color: #FFF; width: ${width / 2}; align: left; anchor: left; value: ${this.data.name}; wrapCount: 20; zOffset: 0.005`)
      title.setAttribute('text', 'font', require('./assets/title-font.woff'))
