...
const BrushList = [
  ...
  new ImageBrush('lines2', {width: 20, height: 20, connected: true, dragRotate: true}),
  new ImageBrush('lines2', {width: 20, height: 20, connected: true, dragRotate: true, textured: true}),
