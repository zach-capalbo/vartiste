...
for (let asset of ['eye.png', 'brush.png', 'floppy.png', 'plus-box-multiple.png', 'shelf.png', 'delete.png', 'arrow-up-bold.png', 'arrow-down-bold.png', 'blur-linear.png', 'check-outline.png', 'help-circle-outline.png', 'arrow-all.png']) {
